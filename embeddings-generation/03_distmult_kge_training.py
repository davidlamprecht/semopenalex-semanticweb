#script to calculate DistMult embeddings for the entities and relations of the soa-sw dataset
import torch
...
with open(".../distmult-kge-summary.txt", "w",) as z:
    start_time = time.ctime()
    z.write(f'Calculate embeddings with DistMult started at: {start_time}\n')
    z.flush()
    print('Calculate embeddings with DistMult started at: ', start_time)
    ...
    end_time = time.ctime()
    z.write(f'Calculate embeddings with DistMult end at: {end_time}\n')
    z.flush()
    print('Calculate embeddings with DistMult end at: ', end_time)
