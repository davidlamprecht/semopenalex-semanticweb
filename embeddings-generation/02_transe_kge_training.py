#script to calculate TransE embeddings for the entities and relations of the soa-sw dataset
import torch
...
with open(".../transe-kge-summary.txt", "w",) as z:
    ...
    z.flush()
    print('Calculate embeddings with TransE started at: ', start_time)
